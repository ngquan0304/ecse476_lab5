...
class ArmMotionAction {
    ...
    public:
        ...
        void executeActionCallback(const mobot_controller::ArmMotionGoalConstPtr &goal)
        {
            ...
            trajectory_msgs::JointTrajectory des_trajectory_right // objects to hold trajectories
            trajectory_msgs::JointTrajectory approach_trajectory_right // objects to hold trajectories    
            trajectory_msgs::JointTrajectoryPoint trajectory_point0;

            //get right arm angles; start motion from here
            ...
            switch (playfile_code) {
                case baxter_playfile_nodes::playfileSrvRequest::PRE_POSE:
                    ...
                    if (0 == read_traj(jsp_data_string, des_trajectory_right)) {
                ...
                case baxter_playfile_nodes::playfileSrvRequest::CMD_ANY_JSP_TRAJ:
                    ...
                    if (0 == read_traj_file(jsp_data_string, des_trajectory_right)) {
                        ROS_INFO("read right-arm file OK");
                        g_got_good_traj_right = true;
                    }
                    break;
